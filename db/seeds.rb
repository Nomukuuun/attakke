...
presets = [
  ...
  { tag: 4, l_name: "トイレ収納棚", s_name: "トイレットペーパー", model: 1, exist_quantity: nil, num_quantity: 8 },
  ...
  { tag: 4, l_name: "トイレ収納棚", s_name: "便座除菌シート", model: 0, exist_quantity: 1, num_quantity: nil },
  ...
  { tag: 6, l_name: "洗面台下収納", s_name: "歯間ブラシ", model: 0, exist_quantity: 1, num_quantity: nil },
